...
module.exports = class Application extends Koa {
  ...
  async created() {
    ...
    this.loader.controller.push(path.join(this.app.options.baseDir, 'app', 'controller'));
    this.loader.middleware.push(path.join(this.app.options.baseDir, 'app', 'middleware'));
    this.loader.service.push(path.join(this.app.options.baseDir, 'app', 'service'));
    this.loader.extend.context.push(path.join(this.app.options.baseDir, 'app', 'extend', 'context.js'));
    this.loader.extend.request.push(path.join(this.app.options.baseDir, 'app', 'extend', 'request.js'));
    this.loader.extend.response.push(path.join(this.app.options.baseDir, 'app', 'extend', 'response.js'));
    this.loader.extend.application.push(path.join(this.app.options.baseDir, 'app', 'extend', 'application.js'));
